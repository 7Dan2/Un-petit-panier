...
let weeklyList = ["Crême solaire", "Mirror", "Eparcyl", "Viande", "Lait", "Vinaigre balsamique", "Eponges", "Céréales", "Barre céréales", "Charcuterie", "Gâteaux", "Confiture", "Pain", "Brioche", "Harengs", "Chips", "Trucs apéro", "Echalottes", "Ail", "Poivron", "Tomates", "Bananes", "Bière", "Oeufs", "Lardons", "Croquettes", "Boulettes", "Glaces", "Moutarde", "Nouilles chinoise", "Huile d'olive", "Dentifrice"]
...
// {
	...
	function copyInArray()
	{
		weeklyList.push(getInput.value);
		console.log(`Liste : ${weeklyList}`);
